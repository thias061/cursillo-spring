...
import com.pokemon.web.PokemonServerApplication;
@RunWith(SpringJUnit4ClassRunner.class)
@SpringBootTest(classes = PokemonServerApplication.class)
@WebAppConfiguration
public class PokemonControllerTest {
	  protected MockMvc mvc;
	   ...
	   @Test
	   public void getPokemonsList() throws Exception {
	      String uri = "/pokemons";
	      ...
	      Pokemon[] productlist = mapFromJson(content, Pokemon[].class);
